    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('mpe')">
            ...
            <div class="w3-right">
                <div class="w3-bar">
                    ...
                    <span v-if="loggedIn">
                        ...
                        <a href="#" @click.prevent="userLogout" id="userMainLogout">Logout</a> |
                        <a href="#" @click.prevent="userAccount">My Account</a>
                    </span>
                        <span v-else>
                        <!-- For non-login or new user -->
                    <i class="glyphicon glyphicon-user" style="color:steelblue;"></i>
                        <label class="text-info">{{mcLabel.welcome}} {{userName}}</label> |
                        <a href="#" @click.prevent="userLogin">Login</a> |
                        <a href="#" @click.prevent="userRegister">Register</a>
                    </span>
                    </div>
        ...
        <div class="w3-container w3-center">
            <div class="w3-bar">
                ...
                <div class="w3-bar-item w3-mobile">
                    <select v-if="searchCategories.length > 0" class="form-control" v-model="searchCategory"
...
<script>
    ...
    import { centralMixin } from "../mixins/centralMixin";
    ...
    export default {
        ...
        data() {
            return {
                ...
                userName       : 'Guest',
                currentProdName: this.$info.getMPETitle(),
                servicePath    : 'mpe',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getMPETitle() || localStorage.getItem( 'currentProdName' );
            ...
            mcLink( pathName ) {
                if( pathName === 'home' ) {
                    this.$store.dispatch( 'central/setProdPath', { path: 'home' } );
                    this.currentProdName = this.$info.getSlogan();
                } else {
            ...
            mcSearch() {
                ...
                this.$store.dispatch( 'central/setSearchCat', this.searchCategory || 'Services' );
                Session.set( {
        ...
        created() {
            ...
            const prodInfo       = this.serviceItems.find( ( item ) => {
                return item.servicePath = this.servicePath;
            } );
            this.currentProdName = prodInfo ? prodInfo.serviceName : this.$info.getMPETitle();
        },
    }
</script>