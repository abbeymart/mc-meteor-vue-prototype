    ...
    export default {
        ...
        data() {
            return {
                ...
                loggedIn       : false,
                userName       : 'Guest',
                currentProdName: this.$info.getSlogan(),
                servicePath    : 'home',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || localStorage.getItem( 'currentProdName' ) || this.$info.getSlogan();
        ...
        created() {
            // Determine the login status | activate loggedIn status to true (part of fetchData)
            // this.fetchData();
        },
    }
</script>
