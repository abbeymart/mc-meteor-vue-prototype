    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('mc')">
    ...
    export default {
        ...
        data() {
            return {
                ...
                userName       : 'Guest',
                currentProdName: this.$info.getProductName(),
                servicePath    : this.$store.getters[ 'central/getProdPath' ] || 'mc',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getProductName() || localStorage.getItem( 'currentProdName' );
            ...
            mcLink( pathName ) {
                // Route based on the pathName
                const currentPath = this.servicePath || pathName;
                this.$store.dispatch( 'central/setProdPath', { path: currentPath } );
                // go to solution / service-item page
                this.$router.push( { name: currentPath } );

                // if( pathName === 'home' ) {
                //     this.$store.dispatch( 'central/setProdPath', { path: 'home' } );
                //     this.currentProdName = this.$info.getProductName();
                // } else {
                //     this.$store.dispatch( 'central/setProdPath', { path: pathName } );
                //     // appBus.currentProdPath( pathName );
                // }
            },
            mcSearch() {
