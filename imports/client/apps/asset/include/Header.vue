    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('asset')">
    ...
    export default {
        ...
        data() {
            return {
                ...
                loggedIn       : false,
                userName       : 'Guest',
                currentProdName: this.$info.getAssetTitle(),
                servicePath    : 'asset',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getAssetTitle() || localStorage.getItem( 'currentProdName' );
