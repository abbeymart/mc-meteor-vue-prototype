    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('hms')">
    ...
    export default {
        ...
        data() {
            return {
                ...
                loggedIn       : false,
                userName       : 'Guest',
                currentProdName: this.$info.getHMSTitle(),
                servicePath    : 'hms',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getHMSTitle() || localStorage.getItem( 'currentProdName' );
