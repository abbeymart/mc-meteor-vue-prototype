    ...
    export default {
        ...
        computed: {
            packageGroups() {
                ...
                let itemPath = this.$store.getters[ 'central/getProdPath' ] || localStorage.getItem( 'currentProdPath' ) || 'home';
        ...
        created() {
            // set the current product-path
            this.prodPath = this.$store.getters[ 'central/getProdPath' ] || localStorage.getItem( 'currentProdPath' ) || 'home';
        },
        updated() {
