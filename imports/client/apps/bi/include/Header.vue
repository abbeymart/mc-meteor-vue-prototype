    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('bi')">
    ...
    export default {
        ...
        data() {
            return {
                ...
                loggedIn       : false,
                userName       : 'Guest',
                currentProdName: this.$info.getBITitle(),
                servicePath    : 'bi',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getBITitle() || localStorage.getItem( 'currentProdName' );
