    ...
    <div>
        ...
        <div class="w3-container w3-margin-8">
            ...
            <table class="w3-table w3-striped w3-border w3-hoverable" id="mcOrgList">
                ...
                <tbody>
                <tr v-for="item in orgItems" :key="item._id" @click.prevent="updateItem(item)">
...
<script>
    ...
    export default {
        ...
        methods   : {
            ...
            industryName( itemId ){
                const itemName = this.$lo.find( this.codeItems, { _id: itemId } );
            ...
            updateItem( item ) {
                ...
                this.$store.dispatch('central/setOrgItem', item);
                this.$store.dispatch('central/setOwnerId', item._id);
