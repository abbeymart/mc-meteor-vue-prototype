<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-th-list"/> {{mcLabel.stdCodeList}}</h4>
        </div>
        <div class="w3-container w3-margin-8">
            ...
            <table class="w3-table w3-striped w3-border w3-hoverable" id="mcCodeList">
                ...
                <tbody>
                <tr v-for="item in codeItems" :key="item._id" @click.prevent="updateItem(item)">
                    <td>{{item.codeName}}</td>
