    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('central')">
...
export default {
  ...
  data() {
    return {
      ...
      loggedIn: false,
      userName: "Guest",
      currentProdName: this.$info.getCentralTitle(),
      servicePath: "central",
  ...
  methods: {
    ...
    mcLink(pathName = "central") {
      this.$store.dispatch("central/setProdPath", { path: pathName });
      this.currentProdName = this.$info.getCentralTitle();
      // go to solution / service-item page
