    ...
    <div class="w3-container">
        ...
        <ul class="nav nav-pills w3-lightgrey">
            <li class="mcBlockLink" style="display: block;">
                <h4>{{mcLabel.grant}} &raquo;&raquo;</h4>
            </li>
            <li class="mcBoldLink"><a href="#" @click.prevent="listItems">{{mcLabel.list}}</a></li>
            <li class="mcBoldLink"><a href="#" @click.prevent="newItem" >New Grant</a></li>
        </ul>
        <div>
    ...
    export default {
        ...
        methods   : {
            ...
            listItems() {
                this.isItem = false;
                Session.set( 'currentGrantItem', '' );
                this.$router.push( { name: 'grantList' } );
            },
        },
        created(){
        ...
        updated(){
            ...
            this.isItem = !!Session.get( 'currentGrantItem' );
        },
    }
