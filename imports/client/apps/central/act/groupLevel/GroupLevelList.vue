<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-th-list"/> {{mcLabel.groupLevelList}}</h4>
        </div>
        <div class="w3-container w3-margin-8">
            ...
            <table class="w3-table w3-striped w3-border w3-hoverable" id="mcRoleList">
                ...
                <tbody>
                <tr v-for="item in roleItems" :key="item._id">
...
<script>
    ...
    export default {
        ...
        methods   : {
            ...
            groupName( groupId ) {
                const groupItem = _.find( this.codeItems, { _id: groupId } );
                return groupItem ? groupItem.codeName : 'n/a';
            },
            serviceName( serviceId ) {
                const serviceItem = _.find( this.serviceItems, { _id: serviceId } );
