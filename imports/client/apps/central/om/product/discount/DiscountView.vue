<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-th-list"/> {{mcLabel.discountView}}</h4>
        </div>
        <div class="w3-container w3-margin-8">
            ...
            <table class="w3-table w3-striped w3-border w3-hoverable" id="mcPayProviderList">
                ...
                <tbody>
                <tr v-for="item in payProviderItems" :key="item._id">
            ...
            if( userToken ) {
                ...
                Meteor.call( 'getPayProvider', queryParams, currentItemId, userToken, ( error, result ) => {
                    if( error ) {
                        ...
                        this.payProviderItems = _.sortBy(result.value, 'payProvider');
                    } else {
                        this.isMessage   = true;
                        this.pageMessage = `${result.code}: ${result.value}`;
                    }
