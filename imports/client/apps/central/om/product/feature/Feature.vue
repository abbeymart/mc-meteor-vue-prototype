    ...
    <div class="w3-container">
        ...
        <ul class="nav nav-pills w3-lightgrey">
            <li class="mcBlockLink" style="display: block;">
                <h4>{{mcLabel.productFeatures}} &raquo;&raquo;</h4>
            </li>
    ...
    export default {
        ...
        methods   : {
            listItems(){
                // reset currentItem
                this.isItem = false;
                Session.set( 'currentProductFeatureItem', '' );
                this.$router.push( { name: 'orderProductFeatureList' } );
            },
            newItem(){
                // reset currentItem
                this.isItem = false;
                ...
                if( parts[ lastIndex ] === 'new' ) {
                    ...
                    this.$router.push( { name: 'orderProductFeatureNew' } );
                }
            },
        },
        created(){
        ...
        updated(){
            ...
            this.isItem = !!Session.get( 'currentProductFeatureItem' );
        },
    }
</script>
