    ...
    <div class="w3-container">
        ...
        <ul class="nav nav-pills w3-lightgrey">
            <li class="mcBlockLink" style="display: block;">
                <h4>{{mcLabel.productReviews}} &raquo;&raquo;</h4>
            </li>
...
<script>
    ...
    export default {
        ...
        methods   : {
            newItem(){
                ...
                if( parts[ lastIndex ] === 'new' ) {
                    ...
                    this.$router.push( { name: 'orderProductReviewNew' } );
                }
            },
            listItems(){
                // reset currentItem
                this.isItem = false;
                Session.set( 'currentReviewItem', '' );
                this.$router.push( { name: 'orderProductReviewList' } );
            },
        },
        created(){
        ...
        updated(){
            ...
            this.isItem = !!Session.get( 'currentReviewItem' );
        },
    }
