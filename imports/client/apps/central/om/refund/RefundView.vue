                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="amountRefundable"
                               ...
                               :value="totalRefundableCost" required disabled>
                    </div>
                    <div class="form-group">
            ...
            totalRefundableCost() {
                ...
                const payInfo = this.payItems.filter( ( pay ) => {
                    return (pay.orderNumber === this.refund.orderNumber
                            && pay.chargeInfo.payStatus !== 'Invoice' );
                } );
                ...
                if( payInfo ) {
                    ...
                    // convert 100 units to whole money (e.g. cents to dollars)
                    amountPaid = (amountPaid - refundedAmount)/100;
                    this.totalRefundable = amountPaid;
                    return `${payCurrency}${numFormat( amountPaid ).format( '0,0.00' )}`;
                }
            }
        },
        methods : {
