<!--TODO: Invoice could suffice for cheque, pod, post-delivery-payment and wire payments > order-payment will be finalised or settled after/upon payment-->
<template>
    <div>
            ...
            <div>
                <div class="w3-container">
                    ...
                    <div class="col-sm-3">
                        ...
                        <hr>
                        <div>
                            <!--TODO: Confirm cash payment / receipt tom complete order-->
                            <button class="btn btn-primary" @click.prevent="invoicePayment">
                                {{mcLabel.payOrder}}
                            </button>
                        </div>
                        <!--<div v-if="!readyToPay">-->
    ...
    export default {
        ...
        data() {
            return {
                ...
                orderPay          : {
                    key        : '',
                    locale     : 'auto',
                    payName    : 'Invoice Payment (Cheque, POD, Wire...)',
                    name       : 'MC',
                    email      : '',
                    productName: '',
                    amount     : 10,
        ...
        methods   : {
            ...
            updateTradeItems( orderId ) {
                ...
                // Set tradePay to 'Invoice' for uniformity of orders' records
                if( this.tradeParams.tradePay !== 'Invoice' ) {
                    this.tradeParams.tradePay = 'Invoice';
                }
            ...
            invoicePayment() {
                ...
                if( !confirm( this.$message.confirmInvoicePayment ) ) {
                    this.isMessage   = true;
                    this.pageMessage = "Confirm invoice-payment (pay-on-delivery, cheque, wire transfer), to complete order";
                    return;
                }
                ...
                if( userToken ) {
                    if( this.$lo.isEmpty( errors ) ) {
                        // reset validateErrors
                        this.validateErrors = '';
                        Meteor.call( 'saveInvoice', payInfo, userToken, ( error, result ) => {
                            if( error ) {
                                this.isMessage   = true;
