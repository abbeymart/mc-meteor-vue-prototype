<template>
    <!--TODO: cancel order or part-of-order (items)-->
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-thumbs-up"></i> {{mcLabel.orderCancelDetail}}</h4>
        </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="payProvider.payLocale" id="payLocale" required>
                            <option disabled value="">{{mcLabel.select}} {{mcLabel.payLocale}}</option>
