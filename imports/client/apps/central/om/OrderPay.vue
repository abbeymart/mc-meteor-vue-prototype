<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-thumbs-up"></i> {{mcLabel.orderPay}}</h4>
        </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="payProvider.payLocation" id="payLocation" required>
                            <option disabled value="">{{mcLabel.selectLocation}}</option>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="payProvider.payType" id="payType" required>
                            <option disabled value="">{{mcLabel.selectType}}</option>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="payProvider.payOwner" id="payOwner">
                            <option disabled value="">{{mcLabel.selectOwner}}</option>
