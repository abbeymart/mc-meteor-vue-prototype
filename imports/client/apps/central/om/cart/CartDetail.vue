<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-thumbs-up"></i> {{mcLabel.cartDetail}}</h4>
        </div>
        ...
        data() {
            return {
                ...
                cart           : {
                    tradeProduct : '',
                    tradeGroup   : 'B2C',
                    tradeFolder  : this.defaultFolder,
                    tradeQuantity: 1,
        ...
        methods : {
            ...
            saveTradeItem() {
                ...
                if( !this.$lo.isEmpty( userItem ) ) {
                    this.cart.tradeOwner = userItem._id;
                }

                // cast/format number parameters
                this.cart.tradeQuantity = Number( this.cart.tradeQuantity );

                // set the tradeFolder unique identifier for the cart / order
//                this.cart.tradeFolder = this.cart.tradeOwner;
        ...
        created(){
            ...
            const item = this.$store.getters['central/getCartItem'];
            if( item ) {
                // console.log( item.tradeFolder );
