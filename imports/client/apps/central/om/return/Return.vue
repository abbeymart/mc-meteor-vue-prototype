    ...
    <div class="w3-container">
        ...
        <ul class="nav nav-pills w3-lightgrey">
            <li class="mcBlockLink" style="display: block;">
                <h4>{{mcLabel.orderReturns}} &raquo;&raquo;</h4>
            </li>
    ...
    export default {
        ...
        methods   : {
            listItems(){
                ...
                Session.set( 'currentReturnItem', '' );
                this.$router.push( { name: 'orderReturnList' } );
            },
            newItem(){
                // reset currentItem
                this.isItem = false;
                ...
                if( parts[ lastIndex ] === 'new' ) {
                    this.$router.push( { name: 'orderReturnDetail' } );
                } else {
                    this.$router.push( { name: 'orderReturnNew' } );
                }
            },
        },
        created(){
        ...
        updated(){
            ...
            this.isItem = !!this.$store.getters['central/getReturnItem'];
        },
    }
</script>
