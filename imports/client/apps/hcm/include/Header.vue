    ...
    <div>
        <div class="w3-container">
            <div class="w3-left">
                ...
                <a href="/" @click.prevent="mcLink('hcm')">
    ...
    export default {
        ...
        data() {
            return {
                ...
                loggedIn       : false,
                userName       : 'Guest',
                currentProdName: this.$info.getHCMTitle(),
                servicePath    : 'hcm',
        ...
        methods   : {
            serviceName( item ) {
                ...
                this.currentProdName = item.serviceName || this.$info.getHCMTitle() || localStorage.getItem( 'currentProdName' );
