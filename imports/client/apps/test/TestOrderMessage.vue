<template>
    <div>
        <div class="w3-container w3-blue w3-round-medium w3-margin-8">
            <h4><i class="glyphicon glyphicon-thumbs-up"></i> {{mcLabel.testOrderMessage}}</h4>
        </div>
        <form class="w3-margin-8">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <button class="btn btn-primary" @click.prevent="testOrderMessage">{{mcLabel.testOrderMessage}}
                    </button>
                </div>
            </div>
        </form>
            ...
            testOrderMessage() {
                ...
                if( userToken ) {
                    if( validOrder ) {
                        ...
                        // this.validateErrors = '';
                        Meteor.call( 'sendOrderEmail', this.orderNumber, userToken, ( error, result ) => {
                            if( error ) {
                                this.isMessage   = true;
