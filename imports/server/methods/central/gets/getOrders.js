/**
 * Created by abbeymart on 2017-08-27
 * Get others by specific parameters for performance
 */
// Import required module(s)
// Import required module(s)
import { Meteor } from 'meteor/meteor';
import { check } from 'meteor/check';
import { searchLog } from '../shared/translog';
...
import { checkError, unAuthorized, tokenExpired, notFound, success } from '../shared/utils';
import _ from 'lodash';

Meteor.methods({
    getCancelledOrders( coll, { collParams = {}, currentDocId = '', token = '', skip = 0, limit = 100000 } ) {
        ...
        // TODO: get cancelled orders (partial or full)
        Orders.find({isCancel: true, "orderItems.isCancel": true});
        ...
        if( userId ) {
            ...
            if( userInfo && userInfo.isAdmin ) {
                if( currentDocId ) {
                    ...
                    items = Orders.findOne({_id: currentDocId, isCancel: true, "orderItems.isCancel": true});
                } else if( collParams ) {
